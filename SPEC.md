...
- C2: Liquid model is `liquid/lfm-2.5-2.6b:free` on OpenRouter — the only Liquid model listed there; LFM2.5-1.2B-Instruct is not available. OpenRouter free tier tonight; sponsor tokens swapped in on the day.
