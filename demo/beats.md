...
| 6 | Seam, pre-empted, 2:35–2:50 | "Nimble grounds the claim while the agent works. Veto verifies the basis when the work ships. Grounding is fetch-time. This is ship-time." | Deck: seam.d2, then the Sep 23 grounding capture | 2:20–2:45 | "we already ground" dies before it is asked |
...
Switch points: deck → terminal at the end of beat 2 (0:40); terminal → deck at the end of beat 5b (2:35). Live arc about 113 s; total about 3:40.
