...
> Corrections applied: `.py` → `.ts`; model per C2; Extract Template → `nimble_extract` per C1; plugin beat dropped per C3 (decided by Devansh, dc60366): Veto's own MCP session instead.
